...
document.getElementById('addCustomer-btn').addEventListener('click', function () {
    ...
    var newcus = customerArrList.filter(function (element) { return element.ID == cId; });
    if (newcus.length > 0) {
...
document.getElementById('deposit').addEventListener('click', function () {
    ...
    if (customerID !== NaN && amount != 0) {
        ...
        if (gCheck) {
            var depositInvoice = new Invoice(invoiceArrList.length + 1, customer, amount, details);
...
document.getElementById('withdraw').addEventListener('click', function () {
    ...
    if (customerID !== NaN && amount != 0) {
        ...
        var gCheck = document.getElementById('generateInvoice').checked;
        if (gCheck && wCheck) {
            var withdrawlInvoice = new Invoice(invoiceArrList.length + 1, customer, amount, details);
...
document.getElementById('purchase-btn').addEventListener('click', function () {
    ...
    var invoice = new Invoice(invoiceArrList.length + 1, customerAccount.getCustomer(), amount, details);
