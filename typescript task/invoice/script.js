...
var accountList = [];
var invoiceList = [];
document.getElementById('addCustomer-btn').addEventListener('click', function () {
    var cId = +document.getElementById('customerID').value;
    var cName = document.getElementById('customerName').value.trim();
    var discount = +document.getElementById('discount').value;
    var newcus = customerList.filter(function (element) { return element.ID == cId; });
    if (newcus.length > 0) {
...
document.getElementById('deposit-btn').addEventListener('click', function () {
    ...
    if (customerID !== NaN && amount != 0) {
        ...
        if (gCheck) {
            var depositInvoice = new Invoice(invoiceList.length + 1, customer, amount, details);
...
document.getElementById('withdraw-btn').addEventListener('click', function () {
    ...
    if (customerID !== NaN && amount != 0) {
        ...
        var gCheck = document.getElementById('generateInvoice').checked;
        if (gCheck && wCheck) {
            var withdrawlInvoice = new Invoice(invoiceList.length + 1, customer, amount, details);
...
document.getElementById('displayModal-btn').addEventListener('click', function () {
    ...
    var discountAmount = +(customerAccount.getCustomer().getDiscount() * amount / 100).toFixed(2);
...
document.getElementById('purchase-btn').addEventListener('click', function () {
    ...
    var invoice = new Invoice(invoiceList.length + 1, customerAccount.getCustomer(), amount, details);
...
var generateInvoice = function (invoice) {
    ...
    var tCaption = document.getElementById('tableCaption');
